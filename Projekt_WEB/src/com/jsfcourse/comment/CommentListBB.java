...
public class CommentListBB {
	...
	public String editComment(Integer uzytkownik, Comment comment){
		if(comment.getUser1().getUserId().toString().equals(uzytkownik.toString()) || userDAO.find(uzytkownik).getUserRole().equals("admin")) {		
		flash.put("comment", comment);		
		return PAGE_COMMENT_EDIT;
		}else {
	...
	public String deleteComment(Integer uzytkownik, Comment comment){
		if(comment.getUser1().getUserId().toString().equals(uzytkownik.toString()) || userDAO.find(uzytkownik).getUserRole().equals("admin")) {
